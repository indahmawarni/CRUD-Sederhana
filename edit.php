  ...
  <body>
   ...
   <br>
    ...
    <div class="form-check">
         <label><input type="checkbox" name="olahraga[]" value="Berenang" 
         <?php if (in_array("Berenang", $dataor)) echo "checked";?>>Berenang</label><br>
         ...
         <label><input type="checkbox" name="olahraga[]" value="Atletik" 
         <?php if (in_array("Atletik", $dataor)) echo "checked";?>>Atletik</label><br>
